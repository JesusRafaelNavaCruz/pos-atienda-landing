...
const inputClass =
  "w-full bg-[#F4F7FC] border border-[#2B3AC7] rounded-xl px-4 py-3 text-[#0D2149] text-sm placeholder:text-slate-500 focus:outline-none focus:border-indigo-500/60 transition-colors duration-200";
...
export default function Contact({ socialLinks }: { socialLinks: SocialLink[] }) {
  ...
  return (
    <section id="contact" className="bg-[#EDF2FA] py-24 px-4 sm:px-6 lg:px-8">
      <div className="max-w-2xl mx-auto">
        <div className="text-center mb-10">
          <h2 className="text-3xl sm:text-4xl font-bold text-[#0D2149] mb-4">
          ...
          <div className="flex items-center gap-3">
            {socialLinks.map((link) => (
              <a
                ...
                className="flex items-center justify-center w-10 h-10 rounded-xl bg-white border border-[#E2E8F3] text-[#46527A] hover:bg-[#F4F7FC] hover:border-[#2B3AC7]/30 transition-all duration-200"
              >
        ...
        <div className="bg-white border border-[#E2E8F3] rounded-3xl p-8 sm:p-10">
          {state.success ? (
            <div className="flex flex-col items-center justify-center gap-4 py-10 text-center">
              ...
              <h3 className="text-[#0D2149] text-xl font-semibold">
                ¡Mensaje enviado!
              </h3>
              <p className="text-[#46527A] text-sm max-w-xs">
